#!/bin/bash
# Solution 2: Dockerfile Creation and Image Building
# Create Dockerfiles for different applications and build custom images

echo "=== Dockerfile Creation and Image Building Exercise Solution ==="
echo
...
echo "1. Verify Python app builds successfully without errors"
echo "2. Check that Python container serves content on port 5000"
echo "3. Verify Go multi-stage build completes"
echo "4. Compare image sizes - Go app should be significantly smaller"
echo "5. Test that Go container serves content on port 8080"
echo "6. Verify .dockerignore excludes unnecessary files"
echo "7. Test both applications respond correctly to health checks"