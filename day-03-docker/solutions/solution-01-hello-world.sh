#!/bin/bash
# Solution 1: Docker Hello World and Basic Commands
# Run your first Docker container, explore Docker CLI, and understand basic concepts

echo "=== Docker Hello World and Basic Commands Exercise Solution ==="
echo
...
echo "1. Verify hello-world output contains 'Hello from Docker!'"
echo "2. Check that ubuntu container shows correct OS release info"
echo "3. Verify nginx container is accessible on port 8080"
echo "4. Confirm container logs show nginx startup messages"
echo "5. Ensure container is properly stopped and removed"
echo "6. Test that docker ps doesn't show the demo-nginx container after removal"