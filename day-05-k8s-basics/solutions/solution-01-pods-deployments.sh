#!/bin/bash
# Solution 1: Kubernetes Pods and Deployments
# Create and manage Pods and Deployments using kubectl

echo "=== Kubernetes Pods and Deployments Exercise Solution ==="
echo
...
echo "1. Verify Pod is created with correct labels and resources"
echo "2. Check that Deployment creates expected number of replica Pods"
echo "3. Confirm scaling changes replica count appropriately"
echo "4. Test that rolling updates proceed without downtime"
echo "5. Verify rollback restores previous deployment state"
echo "6. Ensure proper cleanup removes all created resources"