#!/bin/bash
# Solution 3: File System and Basic Commands
# Explore file system hierarchy, use find, grep, sed, awk, and process management commands

echo "=== Linux File System and Basic Commands Exercise Solution ==="
echo
...
echo "1. Test find commands with different criteria (-name, -type, -size, -mtime)"
echo "2. Test grep with regex patterns and context flags (-A, -B, -C)"
echo "3. Test sed with address ranges and multiple expressions"
echo "4. Test awk with complex field processing and BEGIN/END blocks"
echo "5. Test process commands with different sorting and formatting options"
echo "6. Verify system commands work on your specific distribution"