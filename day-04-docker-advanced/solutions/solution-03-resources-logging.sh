#!/bin/bash
# Solution 3: Docker Resource Management and Logging
# Configure resource constraints, logging drivers, and monitoring

echo "=== Docker Resource Management and Logging Exercise Solution ==="
echo
...
echo "1. Verify containers start with specified resource constraints"
echo "2. Check docker stats shows correct resource usage percentages"
echo "3. Confirm restart policies work as expected"
echo "4. Test logging drivers capture container output correctly"
echo "5. Validate resource reservations don't exceed limits"
echo "6. Ensure proper cleanup removes all demo containers"