#!/bin/bash
# Solution 1: Docker Compose Multi-Container Applications
# Define and run multi-container applications with docker-compose.yml

echo "=== Docker Compose Multi-Container Applications Exercise Solution ==="
echo
...
echo "1. Verify both web and redis services start successfully"
echo "2. Check that web service can connect to redis service"
echo "3. Confirm visit count increments with each request"
echo "4. Test that scaling creates additional web service replicas"
echo "5. Verify service discovery works between containers"
echo "6. Test that configuration updates trigger rolling restarts"
echo "7. Ensure proper cleanup removes all services and volumes"