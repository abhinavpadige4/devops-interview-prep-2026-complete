#!/bin/bash
# Solution 1: Network Configuration and Troubleshooting
# Configure network interfaces, check connectivity, and use network diagnostic tools

echo "=== Network Configuration and Troubleshooting Exercise Solution ==="
echo
...
echo "1. Verify IP address assignment: ip addr show or ifconfig"
echo "2. Test name resolution: nslookup google.com"
echo "3. Check open ports: ss -tuln or netstat -tuln"
echo "4. Verify gateway connectivity: ping <gateway_ip>"
echo "5. Test external connectivity: ping 8.8.8.8"
echo "6. Check routing table: ip route show or netstat -rn"
echo "7. Verify DNS configuration: cat /etc/resolv.conf"
echo "8. Test specific port connectivity: nc -zv localhost 22 (for SSH)"